...
public class TopDownHealthControll : MonoBehaviour
{
    public static TopDownHealthControll instance;
    ...
    void handleDeath()
    {
        LevelMangerZombie.instance.deathScreen.SetActive(true);
        LevelMangerZombie.instance.livingMap.SetActive(false);
        LevelMangerZombie.instance.deathMap.SetActive(true);
        Destroy(gameObject);
